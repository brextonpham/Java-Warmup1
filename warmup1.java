...
public String front22(String str) {
  if (str.length() >= 3) return str.substring(0, 2) + str + str.substring(0, 2);
  return str + str + str;
}
...
public String delDel(String str) {
  if (str.length() >= 4 && str.substring(1, 4).equals("del")) return str.charAt(0) + str.substring(4, str.length());
  return str;
}
